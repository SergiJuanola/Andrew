import sublime, sublime_plugin, subprocess, os, fnmatch, re
	...
	def run(self):
		for folder in self.window.folders() :
			...
			if buildxml is not None :
				...
				projectName = self.buscaProject(buildxml)
				package = self.buscaPackage(manifest)
